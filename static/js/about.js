	...
	let data = [
		{
			...
			answer: '<p>Search their name or other indentifying information using the press release search.</p>',
		},
		{
			id: 'fuzzy',
			question: 'How do I do fuzzy search/inexact matching?',
			answer: '<p>By default, the SDN and press release searches perform fuzzy/inexact matching.  If you notice that halfway down the page, results are no longer relevant, then you can fairly safely stop viewing more results since they are ordered by relevance.</p>',
		},
		{
			id: 'effective',
